...
hooks.register(hooks.type.HIGHLIGHT_SETUP, function()
    vim.api.nvim_set_hl(0, "RainbowRed", { fg = "#E06C75" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowYellow", { fg = "#E5C07B" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowBlue", { fg = "#61AFEF" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowOrange", { fg = "#D19A66" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowGreen", { fg = "#98C379" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowViolet", { fg = "#C678DD" , blend = 50 })
    vim.api.nvim_set_hl(0, "RainbowCyan", { fg = "#56B6C2" , blend = 50 })
end)
